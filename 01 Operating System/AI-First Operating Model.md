...
- COO: intake, routing, decomposition, queue management
...
2. COO converts it into or updates a task in `active-work.json`.
...
8. Weekly review inspects metrics, escalations, and open decisions.
